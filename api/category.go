...
/*
DeleteCategory [删除分类API接口] [240221] [0.1]
------------------------------------------------------------------------------------------------------------------------

	[API] [Private] : api.DeleteCategory
	[URL] [DELETE] : /api/Category/:id

------------------------------------------------------------------------------------------------------------------------

	//:[入参]
	[1]: [DELETE]-->[Param][:id]: 分类的ID
...
func DeleteCategory(ctx *gin.Context) {
	...
	msg, code := Models.DeleteCategory(id)
	ctx.JSON(
		http.StatusOK,
		gin.H{
			"code": code,
...
/*
EditCategory [编辑分类API接口] [240221] [0.1]
------------------------------------------------------------------------------------------------------------------------

	[API] [Private] : api.EditCategory
	[URL] [PUT] : /api/Category/:id

------------------------------------------------------------------------------------------------------------------------

	//:[入参]
	[1]: [PUT]-->[Param][:id]: 分类的ID
