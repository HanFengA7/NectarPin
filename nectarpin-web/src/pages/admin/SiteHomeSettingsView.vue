...
function moveTech(i: number, dir: -1 | 1) {
  const j = i + dir
  if (j < 0 || j >= form.tech_stack.length) return
...
async function load() {
  ...
  try {
    ...
    loadError.value = e instanceof RequestError ? e.message : '无法加载首页配置'
  } finally {
    loading.value = false
  }
}
  ...
  <section class="min-h-svh w-full bg-muted/25">
    ...
    <div class="w-full px-4 pt-6 pb-0 sm:px-6 sm:pt-8 lg:px-8 lg:pt-10">
      <header class="mb-6 text-left sm:mb-8">
        ...
        <h1 class="mt-2 text-2xl font-semibold tracking-tight sm:text-3xl">首页设置</h1>
      ...
      <form v-else class="flex flex-col gap-5 sm:gap-6" @submit.prevent="handleSave">
        <div class="grid gap-5 sm:gap-6 lg:grid-cols-2 lg:items-start">
          ...
          <div class="flex min-w-0 flex-col gap-5 sm:gap-6">
            ...
            <div class="rounded-xl border bg-background p-5 shadow-sm sm:p-6">
              <div class="mb-4 border-b border-border/60 pb-3">
                <h2 class="text-base font-semibold tracking-tight">站点与品牌</h2>
            ...
            <div class="rounded-xl border bg-background p-5 shadow-sm sm:p-6">
              <div class="mb-4 border-b border-border/60 pb-3">
                <h2 class="text-base font-semibold tracking-tight">GitHub 贡献图</h2>
                <p class="mt-1 text-xs text-muted-foreground">
            ...
            <div class="rounded-xl border bg-background p-5 shadow-sm sm:p-6">
              <div class="mb-4 border-b border-border/60 pb-3">
                <h2 class="text-base font-semibold tracking-tight">侧栏头像与角标</h2>
                <p class="mt-1 text-xs text-muted-foreground">
              ...
              <div class="space-y-4">
                <div class="space-y-1.5">
                  ...
                  <Input
                    ...
                    autocomplete="off"
                  />
                  <p class="text-xs text-muted-foreground">须为 http 或 https。</p>
                </div>
                <div class="space-y-1.5">
                ...
                <div class="grid gap-4 sm:grid-cols-2">
                  <div class="space-y-1.5">
                    ...
                    <p class="text-xs text-muted-foreground">装饰用，非按钮。</p>
                  </div>
                  <div class="space-y-1.5">
                    ...
                    <select
                      ...
                      :class="
                        cn(selectBaseClass, 'disabled:cursor-not-allowed disabled:opacity-50')
                      "
                    >
                      <option
            ...
            <div class="rounded-xl border bg-background p-5 shadow-sm sm:p-6">
              <div class="mb-4 border-b border-border/60 pb-3">
                <h2 class="text-base font-semibold tracking-tight">头像下方状态行</h2>
                <p class="mt-1 text-xs text-muted-foreground">
              ...
              <div class="space-y-4">
                ...
                <div class="grid gap-4 sm:grid-cols-2">
                  <div class="space-y-1.5">
                    ...
                    <select id="status_icon" v-model="form.status_icon" :class="selectBaseClass">
                      <option
                  ...
                  <div class="space-y-1.5">
                    ...
                    <p class="text-xs text-muted-foreground">「不显示图标」时颜色无效。</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="flex min-w-0 flex-col gap-5 sm:gap-6">
            ...
            <div class="rounded-xl border bg-background p-5 shadow-sm sm:p-6">
              <div class="mb-4 border-b border-border/60 pb-3">
                <h2 class="text-base font-semibold tracking-tight">首页主文案</h2>
                <p class="mt-1 text-xs text-muted-foreground">
            ...
            <div class="rounded-xl border bg-background p-5 shadow-sm sm:p-6">
              <div
                class="mb-4 flex flex-wrap items-end justify-between gap-3 border-b border-border/60 pb-3"
              >
                <div>
                  <h2 class="text-base font-semibold tracking-tight">社交链接</h2>
                  <p class="mt-1 text-xs text-muted-foreground">
                    首页主区按钮式外链（仅展示含有效地址的项）。运行天数与备案请在
                    <RouterLink
                      :to="{ name: 'global-siteSettings-footer' }"
                ...
                >
                  <div class="grid min-w-0 flex-1 gap-3 sm:grid-cols-2">
                    <div class="space-y-1.5">
                      ...
                      <Input :id="`soc_label_${i}`" v-model="item.label" placeholder="GitHub" />
                    </div>
            ...
            <div class="rounded-xl border bg-background p-5 shadow-sm sm:p-6">
              ...
              >
                <div>
                  <h2 class="text-base font-semibold tracking-tight">技术栈标签</h2>
                  <p class="mt-1 text-xs text-muted-foreground">下拉选底色；右侧调整顺序或删除。</p>
                </div>
                <Button
                  type="button"
                  variant="outline"
              ...
              <ul class="space-y-2">
                ...
                >
                      ...
                      <div class="space-y-1.5">
                        ...
                        <div class="flex items-center gap-2">
                          ...
                          <select
                            ...
                            :class="cn(selectBaseClass, 'w-[min(100%,9.5rem)] px-2 sm:w-40')"
                            aria-label="标签底色"
                          >
                            <option
                  ...
                  >
                    <Label
                      :for="`tech_cls_${i}`"
                      class="shrink-0 text-xs text-muted-foreground sm:w-28"
                    >
                      自定义 Tailwind 类
                    </Label>
                    <Input
                    ...
                    />
                    <p class="w-full text-[11px] text-muted-foreground">在下拉中选预设可覆盖。</p>
                  </div>
                </li>
              </ul>
            </div>
