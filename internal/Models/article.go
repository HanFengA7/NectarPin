...
type Article struct {
	...
	Title         string         `gorm:"column:title; type:varchar(255);not null" json:"title" label:"文章标题" binding:"required"`
	...
	Content       string         `gorm:"column:content; type:longtext" json:"content"  label:"文章正文" binding:"required"`
	ImgUrl        string         `gorm:"column:img_url; type:longtext" json:"img_url" label:"文章展图"`
	AIFComment    int            `gorm:"column:aif_comment; type:int; not null;" json:"aif_comment" label:"是否开启评论" binding:"required"`
	AIFHide       int            `gorm:"column:aif_hide; type:int; not null;" json:"aif_hide" label:"是否隐藏文章" binding:"required"`
	AIFEncrypt    int            `gorm:"column:aif_encrypt; type:int; not null;" json:"aif_encrypt" label:"是否加密文章" binding:"required"`
